function Blog() {
    return (
      <div>
        <h1>Doctors deliver crushing news</h1>
    <img src="https://alexeilastovetski.files.wordpress.com/2021/06/doctors.jpg" alt="logo" height="100px" />
    <p>After countless consultations, Royal Medical Academy experts concluded that penis reduction surgery is not an option for Alexei.
...
Mon, 28th of June, 2021 Yaroslav Summergeese, CNBC</p>
